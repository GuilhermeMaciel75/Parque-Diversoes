...
INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(4, '777.777.777-77', '400.400.400-40', 4, to_timestamp('08/10/2015 10:32:57', 'DD/MM/YYYY HH:MI:SS'));
INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(5, '333.333.333-33', '400.400.400-40', 5, to_timestamp('02/01/2023 08:15:33', 'DD/MM/YYYY HH:MI:SS'));
INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(6, '444.444.444-44', '400.400.400-40', 2, to_timestamp('13/07/2012 05:22:41', 'DD/MM/YYYY HH:MI:SS'));

INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(7, '999.999.999-99', '200.200.200-20', 1, to_timestamp('22/12/2013 09:05:59', 'DD/MM/YYYY HH:MI:SS'));
INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(8, '555.555.555-55', '200.200.200-20', 2, to_timestamp('13/12/2019 04:44:29', 'DD/MM/YYYY HH:MI:SS'));
INSERT INTO Bilheteria(ingresso, cliente, atendente, promocao, data_e_hora) VALUES(9, '100.100.100-10', '200.200.200-20', 6, to_timestamp('13/12/2019 04:44:29', 'DD/MM/YYYY HH:MI:SS'));
